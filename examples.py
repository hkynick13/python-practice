...
def get_weekday(current_weekday: int, days_ahead: int) -> int:
    ...
    current_weekday is the current day of the week and is in a range of 1 - 7, indicating whether today is Sunday (1), Monday (2),  ..., Saturday (7).
...
def get_birthday_weekday(current_weekday: int, current_day: int, birthday_day: int) -> int:
    """Return the day of the week it will be on birthday_day, given that the day of the week is current_day.
